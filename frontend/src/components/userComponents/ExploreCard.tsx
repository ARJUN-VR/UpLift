...
export const ExploreCard = () => {
 ...
 <div
      ...
      <div
        className="p-8  mt-4 flex items-center rounded-lg px-4 duration-300 cursor-pointer hover:bg-white text-gray hover:text-gray bg-[#1d263b] shadow-lg" onClick={()=>navigate('/category/:Game')}
      >
        <i className="bi bi-house-door-fill"></i>
        <span className="text-[15px] ml-4  font-bold">Games</span>
      </div>
      <div
        className="p-8  mt-4 flex items-center rounded-lg px-4 duration-300 cursor-pointer hover:bg-white text-gray hover:text-gray bg-[#1a2c3a] shadow-lg" onClick={()=>navigate('/category/:Popular')}
      >
        <i className="bi bi-house-door-fill"></i>
