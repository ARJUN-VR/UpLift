...
export const ExploreCard = () => {
 ...
 <div
      ...
      <div
        className="p-8 mt-4  flex items-center rounded-lg px-4 duration-300 cursor-pointer hover:bg-white text-gray hover:text-gray bg-[#4a6241] shadow-lg"
      >
        <i className="bi bi-house-door-fill"></i>
        <span className="text-[15px] ml-4  font-bold">Art</span>
      </div>
      <div
        className="p-8  mt-4 flex items-center rounded-lg px-4 duration-300 cursor-pointer hover:bg-white text-gray hover:text-gray bg-[#1d263b] shadow-lg"
      >
        <i className="bi bi-house-door-fill"></i>
