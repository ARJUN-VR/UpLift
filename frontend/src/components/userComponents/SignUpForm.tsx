      ...
      <div className="pointer-events-none relative hidden h-screen select-none bg-black md:block md:w-1/2">
        <div className="absolute bottom-0 z-10 px-8 text-white opacity-100">
          <p className="mb-8 text-3xl font-semibold leading-10">
            We work 10x faster than our stay . While they're bogged won with
            techincal debt, we're realeasing new features.
          </p>
        ...
        <img
          ...
          src="https://static.vecteezy.com/system/resources/previews/006/528/133/original/world-map-connection-background-map-design-technology-communication-connecting-vector.jpg"
        />
      </div>
    </div>
  );
