...
import { useGetDashboardDataMutation, useGetPaymentDataMutation } from "../../redux/slices/userApiSlice";
...
export const CreatorDashboard = () => {
  ...
  const [getPayments,{isLoading:paymentLoading}] = useGetPaymentDataMutation()
      ...
      <div className=" flex p-2 bg-[#808080] rounded-lg ">
        ...
        <div className="w-72 bg-[#141414] h-52 pl-3 ml-3 rounded-lg ">
          ...
          <div className="mt-10 flex justify-center">
            <span className="text-blue-600 font-bold text-7xl"><CountUp end={backers} duration={3}/></span>
        ...
        <div className="w-72 bg-[#141414] h-52 pl-3 ml-5 rounded-lg ">
          ...
          <div className="mt-10 flex items-center flex-col">
            <span className="text-blue-400 font-bold text-4xl"> ₹<CountUp end={currentAmount} duration={3}/></span>
            <span className="text-gray-400 font-semibold">out of</span>
            <span className="text-green-400 font-bold text-4xl"> ₹<CountUp end={target} duration={3}/></span>
